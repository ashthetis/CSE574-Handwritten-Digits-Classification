...
n_class = 10
if os.path.exists('ML.csv'):
    os.remove('ML.csv')

matrixiteration=[0,1,2]

with open('ML.csv', 'a', newline='\n', encoding='utf-8') as csvFile:
    ...
    for index in matrixiteration:
        ...
        for number_of_nodes in np.arange(4,104,4):
            ...
            for lamb in np.arange(0,65,5):
                ...
                #You need to figure out the optimal regularization parameter by testing on the validation data set for
                #different values of λ and find the one that gives the best accuracy.
